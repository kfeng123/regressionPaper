...
\begin{figure}
    ...
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_uniform_t_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_uniform_t_sparse}
    }
    \\
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_uniform_chi_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_uniform_chi_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_uniform_t_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_uniform_t_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_uniform_chi_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_uniform_chi_sparse}
    }
...
\begin{figure}
    \centering 
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_equalCor_t_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_equalCor_t_sparse}
    }
    \\
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_equalCor_chi_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_equalCor_chi_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_equalCor_t_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_equalCor_t_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_equalCor_chi_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_equalCor_chi_sparse}
    }
    \caption{Box plots of the empirical powers based on $100$ independently generated $\bbeta_b$.
...
\begin{figure}
    \centering 
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_factor_t_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_factor_t_sparse}
    }
    \\
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_factor_chi_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_factor_chi_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_factor_t_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_factor_t_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_factor_chi_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_factor_chi_sparse}
    }
    \caption{Box plots of the empirical powers based on $100$ independently generated $\bbeta_b$.
...
\begin{figure}
    \centering 
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_rowCor_t_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_rowCor_t_sparse}
    }
    \\
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_rowCor_chi_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{50_rowCor_chi_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_rowCor_t_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim t_9$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_rowCor_t_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_rowCor_chi_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{100_rowCor_chi_sparse}
    }
    \caption{Box plots of the empirical powers based on $100$ independently generated $\bbeta_b$.
