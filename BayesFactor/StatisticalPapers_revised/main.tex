...
%Classical frequentist considerations may not be valid for this problem.
This problem is highly irregular in the frequentist point of view.
%In fact, we prove that there does not exist nontrivial unbiased test for this problem.
