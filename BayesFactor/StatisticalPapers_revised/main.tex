...
(abbreviated as NEW) 
and compare it with the global test proposed by \cite{Goeman2006} (abbreviated as GT), the EigenPrism test prospoed by \cite{Janson2016} (abbreviated as EP) and the bootstrap-assisted test proposed by \cite{ZC2017} (abbreviated as BA).
...
Hence we implement the oracle version of their test which reject the null hypothesis when 
\begin{equation*}
