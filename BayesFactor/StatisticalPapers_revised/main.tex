...
Since the forms of the power functions are fairly complicated, it is hard to compare the two tests in general.
Nevertheless, the forms of the power functions can be simplified under more restricted assumptions.
We have the following proposition.
\begin{proposition}
