...
In Bayesian literature, Bayes factor (see, e.g., \cite{Robert1995Bayes}) is a fundamental tool for hypotheses testing adn model comparison.
...
Later we will show that our test method can be applied for general distribution.
