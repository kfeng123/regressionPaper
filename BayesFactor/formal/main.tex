...
\begin{abstract}
    ...
    It turns out that the proposed test has good power behavior especially when the signal is strong.
...
This phenomenon is particularly clear for the equal correlation structure setting.
