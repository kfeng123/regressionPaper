...
\begin{figure}
    ...
    \subfigure[$n=50$, $\epsilon_1\sim t_8$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_iidnormal_t_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim t_8$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_iidnormal_t_sparse}
    }
    \\
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_iidnormal_chi_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_iidnormal_chi_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim t_8$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_iidnormal_t_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim t_8$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_iidnormal_t_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_iidnormal_chi_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_iidnormal_chi_sparse}
    }
...
\begin{figure}
    \centering 
    \subfigure[$n=50$, $\epsilon_1\sim t_8$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_Toeplitz_t_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim t_8$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_Toeplitz_t_sparse}
    }
    \\
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_Toeplitz_chi_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_Toeplitz_chi_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim t_8$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_Toeplitz_t_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim t_8$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_Toeplitz_t_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_Toeplitz_chi_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_Toeplitz_chi_sparse}
    }
    \caption{Box plots of the empirical powers based on $25$ independently generated $\bbeta_b$ and $5$,$000$ independent replications.
...
\begin{figure}
    \centering 
    \subfigure[$n=50$, $\epsilon_1\sim t_8$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_equalCor_t_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim t_8$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_equalCor_t_sparse}
    }
    \\
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_equalCor_chi_dense}
    }
    \subfigure[$n=50$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/50_equalCor_chi_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim t_8$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_equalCor_t_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim t_8$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_equalCor_t_sparse}
    }
    \\
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Dense $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_equalCor_chi_dense}
    }
    \subfigure[$n=100$, $\epsilon_1\sim (\chi^2(4)-4)/\sqrt{8}$. Sparse $\bbeta_b$.]{
        \includegraphics[width=0.45\textwidth]{code/tmp/100_equalCor_chi_sparse}
    }
    \caption{Box plots of the empirical powers based on $25$ independently generated $\bbeta_b$ and $5$,$000$ independent replications.
